...
output <- lapply(seq(1,15), getRedundancy, species = species) 
...
write.table(speciesInfo, paste0("/home/shumphrey/GenomicInformationAnalysis/Data/Redundancy/", species, "_", seqType, "_RedundancyInfoTable.txt"), sep = "\t", col.names = TRUE, row.names = FALSE, quote = FALSE)
