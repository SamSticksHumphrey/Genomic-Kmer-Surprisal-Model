...
//
// This MapReduce MPI code outputs the distribution of all annotated pre-mRNA transcripts. 
...
//#define Dist
#include "UnsplicedDistribution.h"
...
int main(int narg, char **args){
        ...
        if(maindata.me == 0) {std::cout << std::endl << "Debug 2:" <<  maindata.input_exonfilename << std::endl;}
